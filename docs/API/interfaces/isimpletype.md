...
▸ **is**(`thing`: any): _thing is T | this["Type"]_
...
**Returns:** _thing is T | this["Type"]_
...
▸ **validate**(`thing`: T, `context`: [IValidationContext](../index.md#ivalidationcontext)): _[IValidationResult](../index.md#ivalidationresult)_
